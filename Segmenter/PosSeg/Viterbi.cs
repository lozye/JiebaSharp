...
namespace JiebaNet.Segmenter.PosSeg
{
    public class Viterbi
    {
        ...
        {
            _startProbs = FileExtension.LoadString<Dictionary<string, double>>(ConfigManager.PosProbStartFile);
            _transProbs = FileExtension.LoadString<Dictionary<string, IDictionary<string, double>>>(ConfigManager.PosProbTransFile);
            _emitProbs = FileExtension.LoadString<Dictionary<string, IDictionary<char, double>>>(ConfigManager.PosProbEmitFile);
            _stateTab = FileExtension.LoadString<Dictionary<char, List<string>>>(ConfigManager.CharStateTabFile);
        }
